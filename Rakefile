...
desc 'Generate documentation for the spree_recommend extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SpreeRecommendExtension'
...
desc 'Test the spree_recommend extension.'
...
namespace :test do
  desc 'Functional test the spree_recommend extension.'
  ...
  desc 'Unit test the spree_recommend extension.'
